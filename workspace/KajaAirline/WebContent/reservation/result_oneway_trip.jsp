	...
	<tr>
		<td>
			<div class="date">
				...
				<input type="date" id="boardingDate" name="bDate" value="" style="width:260px; height:30px;" required="required">			
			</div>
		</td>
	</tr>
	<tr>
		<td colspan="2">
			<div class="person">
				...
				<input type="text" id="boardingPerson" name="bPerson" value="" onclick="openPersonLy('passenger');" style="width:260px; height:30px; position: relative;" readonly="readonly">
